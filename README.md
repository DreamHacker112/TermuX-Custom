...
```
cd && rm -rf TermuX-Custom && cd /data/data/com.termux/files/usr/etc && rm -rf bash.bashrc dbus-1 bash_completion.d login.sh krb5.conf mpv pulse ssh && cd /data/data/com.termux/files/usr/etc && echo '# Command history tweaks:
