...
echo 
PS1='\[\033[1;92m\]╭─[\[\033[1;91m\]$names\[\033[1;92m\]]──[\[\033[0;96m\]\w\[\033[1;92m\]]\[\033[0;35m\]$(git branch 2>/dev/null | grep -e "^\*" | sed "s/^\* //")\n\[\033[1;92m\]╰─\[\033[1;93m\](\[\033[38;5;226m\]\#\[\033[1;93m\])─>\[\033[1;96m\] '
<< comment
